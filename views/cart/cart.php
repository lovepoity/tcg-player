  ...
  if (!isset($_SESSION['user_id'])) {
    // Hiển thị nội dung giỏ hàng trống cho người dùng chưa đăng nhập
  ?>
    <div class="container">
      <div class="cart">
        <div class="shopping__cart">
          <div style="width: 100%;" class="cart__container">
            <h1>Shopping Cart</h1>
            <figure>
...
");
  ...
  if ($cart_is_empty) {
    // Hiển thị nội dung giỏ hàng trống cho người dùng đã đăng nhập
  ?>
    <div class="cart">
      <div class="shopping__cart">
        <div style="width: 100%;" class="cart__container">
